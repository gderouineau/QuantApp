# neuronal_strategy/management/commands/ns_validate.py
...
class Command(BaseCommand):
    help = "Validate predictions parquet: metrics (precision/recall/F1) + backtest sur période validation (mois pairs)."
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument("--min_preds", type=int, default=0,
                            help="Min nombre de prédictions positives pour valider un seuil auto.")
        parser.add_argument("--target_precision", type=float, default=0.0,
                            help="Précision cible minimale pour le choix auto.")
    ...
    def handle(self, *args, **opts):
        ...
        try:
            ...
            # 2) Masque validation ALIGNE (pair/impair selon timeframe)
            ...
            # 5) Backtest sur période validation
            ...
            if log_equities:
                ...
                mean_log = max(min(mean_log, 50.0), -50.0)  # bornage
